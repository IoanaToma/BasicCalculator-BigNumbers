...
int main()
{
    ...
    BigNumber<int> FirstNr, SecondNr, SumNr, SubNr, MultiNr;
    int n1, n2;
    
    Even_BigNumber<int> Even;
    cout << "Dati un numar par: ";
    cin >> Even;
    cout << "Numarul este: " << Even << endl;
    
    Fibonacci_BigNumber<int> Fib;
    cout << "Dati un numar Fibonacci: ";
    cin >> Fib;
    cout << "Numarul este: " << Fib;
     
    Even_Fibonacci_BigNumber<int> EvenFib;
    cout << endl << "Dati un numar Fibonacci par: ";
    cin >> EvenFib;
    cout << "Numarul este: " << EvenFib << endl << endl;
    ...
    cout << endl << "Mostra (pentru numerele citite din fisier si vectorii cititi din fisier): " << endl;
