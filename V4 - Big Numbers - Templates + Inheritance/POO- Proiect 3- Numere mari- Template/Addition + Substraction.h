...
template <class T2> void BigNumber<T2>::sum (BigNumber<T2> FirstNr, BigNumber<T2> SecondNr) //suma a doua numere de acelasi semn (suma uzuala)
{
    int k = 0, s;
    elem<int> *first = FirstNr.start->next, *second = SecondNr.start->next;
...
template <class T2> void BigNumber<T2>::sub (BigNumber<T2> FirstNr, BigNumber<T2> SecondNr) //diferenta a doua numere de acelasi semn (diferenta uzuala)
{
    int k = 0, d;
    elem<int> *first = FirstNr.start->next, *second = SecondNr.start->next;
...
template <class T2> BigNumber<T2> BigNumber<T2>::operator+ (BigNumber<T2> SecondNr) //supraincarcarea operatorului +
{
    BigNumber Sum;
...
template <class T2> BigNumber<T2> operator- (BigNumber<T2> FirstNr, BigNumber<T2> SecondNr) //supraincarcarea operatorului -
{
    int n1, n2, ok;
