...
void greater_number (BigNumber FirstNr, BigNumber SecondNr, int &ok, int n1, int n2, BigNumber &Great)
{
    Great.delete_number();
...
void write_greater (BigNumber FirstNr, BigNumber SecondNr, int n1, int n2)
{
    if (n1 < n2) //daca primul numar are mai putine cifre, cel de-al doilea este clar mai mare in modul
